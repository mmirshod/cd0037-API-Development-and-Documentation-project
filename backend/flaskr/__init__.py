...
def create_app(test_config=None):
    ...
    def categories():
        ...
        return jsonify(
            {"success": True, "categories": data, "total_categories": len(data)}
        )
    ...
    def create_question():
        ...
        try:
            ...
            new_question = Question(
                question=name, answer=answer, category=category, difficulty=difficulty
            )
        ...
        return jsonify({"success": True, "message": "New Question has been added."})
